...
If you have a PC, you should download [this zip file](https://github.com/heckacharla/Modern-Halftones-and-Dithering/releases/download/v0.83/Modern_Halftones_for_WINDOWS_v086.zip), which has the .exe and everything you need to run. If you have a Mac, you should download [this zip file](https://github.com/heckacharla/Modern-Halftones-and-Dithering/releases/download/v0.83/Modern_Halftones_for_Macintosh_v083.zip), which has everything you need to run.
...
The zine has its own license, which is in it's .zip file.
